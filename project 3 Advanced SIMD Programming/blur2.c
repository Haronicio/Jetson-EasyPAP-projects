...
return 0;
      ...
      //sum_r[0] = u16_col0_high[3][7] + u16_col1_low[3][0] + u16_col1_low[3][0]
      //sum_r[1] = u16_col1_low[3][0] + u16_col1_low[3][1] + u16_col1_low[3][2]
      //sum_r[2] = u16_col1_low[3][1] + u16_col1_low[3][2] + u16_col1_low[3][3]
      //...
      //sum_r[15] = u16_col1_high[3][6] + u16_col1_high[3][7] + u16_col2_low[3][0]
